...
// Validation helper to keep component body clean
const validateForm = (data) => {
  ...
  if (!data.sizes.trim()) return "Please provide at least one size (e.g., S, M, L).";
...
const EditProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate using the current state values
