...
function ProductDetails() {
  ...
  if (!product) {
    return (
      <div className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <Link
          to="/products"
          className="mt-6 inline-block px-6 py-2.5 bg-primary-nav text-white rounded-xl font-semibold hover:bg-accent transition"
        >
          Back to Shop
        </Link>
      </div>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 md:py-12 text-left">
      ...
      <nav
        className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-text-muted mb-8"
        aria-label="Breadcrumb"
      >
        <Link to="/" className="hover:text-primary-nav transition">
          Home
        </Link>
        <span className="text-border-color">/</span>
        <Link to="/products" className="hover:text-primary-nav transition">
          Products
        </Link>
        <span className="text-border-color">/</span>
        ...
        <div className="flex flex-col ">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-xs font-bold text-text-muted">
              ...
              <span className="text-text-main">
                {product.brand || "VogueGen Signature"}
              </span>
            </span>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-xs text-text-muted mt-1">
              Inclusive of all duties and local sales taxes.
            </p>
          </div>
          ...
          {product.sizes && product.sizes.length > 0 && (
            <div className="mb-6">
              <div className="flex justify-between items-center mb-3">
                ...
                <a
                  href="#size-chart"
                  className="text-xs font-semibold text-primary-nav hover:underline"
                >
                  Size Chart
                </a>
              </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center w-fit border border-border-color rounded-xl bg-white p-1">
              ...
              <span className="w-12 text-center font-bold text-sm text-text-main">
                {quantity}
              </span>
              <button
                onClick={() =>
          ...
          <div className="border border-border-color rounded-2xl overflow-hidden bg-white">
            ...
            <div className="p-5 text-sm leading-relaxed text-text-muted">
              ...
              {activeTab === "shipping" && (
                <p>
                  Enjoy free carbon-neutral shipping on orders over ₹2,000.
                  Delivery arrives in 3–5 business days with standard door
                  tracking. Free returns within 14 days.
                </p>
              )}
            </div>
          </div>
            ...
            {relatedProducts.map((item) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <span className="font-extrabold text-sm text-primary-nav">
                    ₹{item.price}
                  </span>
                </div>
              </Link>
