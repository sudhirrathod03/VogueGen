    ...
    <div className="min-h-screen bg-[#F7F9FC] p-8">
      ...
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center border-b border-gray-200 pb-6 mb-10 gap-4">
        <div className="text-center sm:text-left">
          <h1 className="text-4xl font-bold text-[#185FA5]">Products</h1>
            ...
            <div className="bg-[#E8EEF5] border border-[#D3D1C7] rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col relative group h-full">
              ...
              <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="mt-auto flex items-center justify-between pt-4 border-t border-gray-200/40">
                  <button className="px-8 py-3 bg-[#185FA5] cursor-pointer hover:bg-[#378ADD] text-white rounded-xl font-semibold transition">
                    View Product
                  </button>
